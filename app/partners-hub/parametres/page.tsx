      ...
      >
        <div className="flex h-full flex-col p-4 lg:p-6">
          ...
          <nav className="flex-1 space-y-1">
            <div className="mb-4">
              <p className="px-3 text-xs font-semibold uppercase tracking-wider text-neutral-500">NAVIGATION</p>
            </div>
            ...
            <div className="mb-4">
              <p className="px-3 text-xs font-semibold uppercase tracking-wider text-neutral-500">COMPTE</p>
            </div>
            ...
            <Link
              ...
              className="flex items-center gap-3 rounded-lg bg-green-500/20 px-3 py-2.5 text-white"
            >
              <svg className="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="mb-4">
              <p className="px-3 text-xs font-semibold uppercase tracking-wider text-neutral-500">SUPPORT</p>
            </div>
            ...
            <div className="mt-auto pt-4">
              <div className="rounded-lg bg-neutral-800/50 p-4">
                <p className="mb-2 text-sm font-medium text-white">Besoin d&apos;aide ?</p>
                <p className="mb-3 text-xs text-neutral-400">Contactez le support du Hub</p>
