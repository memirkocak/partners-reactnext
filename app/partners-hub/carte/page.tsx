        ...
        <div className="flex h-full flex-col p-4 lg:p-6">
          ...
          <nav className="flex-1 space-y-1">
            ...
            <Link
              ...
              className="flex items-center gap-3 rounded-lg px-3 py-2.5 bg-neutral-800/50 text-green-400 border-l-4 border-green-500"
            >
              <svg className="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <Link
              href="/dashboard"
              className="mt-4 flex items-center gap-3 rounded-lg px-3 py-2.5 text-neutral-400 transition-colors hover:bg-neutral-800/50 hover:text-white"
            >
              <svg className="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
