      ...
      <div className="w-full max-w-md space-y-8 rounded-xl border border-neutral-800 bg-neutral-900 p-8">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              <input
                ...
                className="h-4 w-4 rounded border-neutral-700 bg-neutral-950 text-green-500 focus:ring-green-500"
              />
              <label htmlFor="rememberMe" className="text-sm text-neutral-400">
                Se souvenir de moi
              </label>
            </div>
            <Link href="#" className="text-sm text-green-400 hover:text-green-300 underline">
              Mot de passe oublié ?
            </Link>
          </div>
        ...
        <div className="relative">
          ...
          <div className="relative flex justify-center text-sm">
            <span className="bg-neutral-900 px-4 text-neutral-500">Ou se connecter avec</span>
          </div>
        </div>
